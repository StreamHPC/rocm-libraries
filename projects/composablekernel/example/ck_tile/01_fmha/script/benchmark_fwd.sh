...
$EXE -prec=$prec -b=32 -h=$nhead -d=$hdim -s=512   -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
$EXE -prec=$prec -b=16 -h=$nhead -d=$hdim -s=1024  -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
$EXE -prec=$prec -b=8  -h=$nhead -d=$hdim -s=2048  -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
$EXE -prec=$prec -b=4  -h=$nhead -d=$hdim -s=4096  -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
$EXE -prec=$prec -b=2  -h=$nhead -d=$hdim -s=8192  -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
$EXE -prec=$prec -b=1  -h=$nhead -d=$hdim -s=16384 -iperm=$perm -operm=$perm -kname=1 -qscale="pt" -init=3 -lse=0 -vlayout=c -v=$VALID ; sleep 1
